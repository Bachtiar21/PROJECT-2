...
--
-- Table structure for table `prediksi_pegawai`
--

CREATE TABLE `prediksi_pegawai` (
  `id` bigint(20) NOT NULL,
  `YearsExperience` double NOT NULL,
  `Salary` double NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `prediksi_pegawai`
--

INSERT INTO `prediksi_pegawai` (`id`, `YearsExperience`, `Salary`) VALUES
(6, 12, 99999);
...
--
-- Indexes for table `prediksi_pegawai`
--
ALTER TABLE `prediksi_pegawai`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `prediksi_pegawai`
--
ALTER TABLE `prediksi_pegawai`
